...
import Duration, {
  ...
  convertToParts as DurationConvertToParts,
  partsToDuration as DurationPartsToDuration,
  partsToSlots as DurationPartsToSlots,
  parseUnitsToParts as DurationParseUnitsToParts,
  parseTimeToParts as DurationParseTimeToParts,
  parseDurationToParts as DurationParseDurationToParts,
  parseToParts as DurationParseToParts,
  dateToSlots as DurationDateToSlots
} from '@darkwolf/duration'
import Timestamp, {
  isTimestamp as TimestampIsTimestamp,
  getDaysInMonth as TimestampGetDaysInMonth,
  from as TimestampFrom
} from '@darkwolf/timestamp'
...
class Period {
  ...
  with(slots) {
    ...
    return new Period(
      years !== undefined ? years : this[yearsSymbol],
      months !== undefined ? months : this[monthsSymbol],
      days !== undefined ? days : this[daysSymbol],
      hours !== undefined ? hours : this[hoursSymbol],
      minutes !== undefined ? minutes : this[minutesSymbol],
      seconds !== undefined ? seconds : this[secondsSymbol],
      milliseconds !== undefined ? milliseconds : this[millisecondsSymbol],
      microseconds !== undefined ? microseconds : this[microsecondsSymbol],
      nanoseconds !== undefined ? nanoseconds : this[nanosecondsSymbol]
    )
  }
